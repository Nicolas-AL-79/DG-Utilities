                        ...
                        .executes(context -> {
                            ...
                            for (ServerPlayer player : players) {
                                ...
                                player.sendSystemMessage(ModMessages.get(
                                        player,
                                        "command.dg_utilities.freeze.frozen",
                            ...
                            context.getSource().sendSuccess(() ->
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.dg_utilities.freeze.success",
                                ...
                                .executes(context -> {
                                    ...
                                    for (ServerPlayer player : players) {
                                        ...
                                        player.sendSystemMessage(
                                                ModMessages.get(
                                                        player,
                                                        "command.dg_utilities.freeze.frozen_timed",
                                    ...
                                    context.getSource().sendSuccess(() ->
                                            ModMessages.get(context.getSource(),
                                                    "command.dg_utilities.freeze.success_timed",
                                                    players.size()
                        ...
                        .executes(context -> {
                            ...
                            for (ServerPlayer player : players) {
                                ...
                                player.sendSystemMessage(
                                        ModMessages.get(
                                                player,
                                                "command.dg_utilities.unfreeze.unfrozen",
                            ...
                            context.getSource().sendSuccess(() ->
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.dg_utilities.unfreeze.success",
