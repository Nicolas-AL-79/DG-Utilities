                ...
                .then(Commands.argument("item", ItemArgument.item(buildContext))
                        .executes(context -> {
                            ...
                            context.getSource().sendSuccess(() ->
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemforbid.success",
                                            "Item "
                        ...
                        .executes(context -> {
                            ...
                            if (items.isEmpty()) {
                                context.getSource().sendFailure(
                                        ModMessages.get(
                                                context.getSource(),
                                                "command.mod_de_teste.itemforbid.list.empty",
                            ...
                            context.getSource().sendSuccess(
                                    () -> ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemforbid.list",
                        ...
                        .executes(context -> {
                            ...
                            if (forbidden) {
                                context.getSource().sendSuccess(
                                        () -> ModMessages.get(
                                                context.getSource(),
                                                "command.mod_de_teste.itemforbid.check.forbidden",
                                                "Item "
                                                        + item.getDescription().getString()
                                                        + " is forbidden.",
                                                item.getDescription()
                            ...
                            context.getSource().sendFailure(
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemforbid.check.allowed",
                                            "Item "
                                                    + item.getDescription().getString()
                                                    + " is not forbidden.",
                                            item.getDescription()
                        ...
                        .executes(context -> {
                            ...
                            if (!changed) {
                                context.getSource().sendFailure(
                                        ModMessages.get(
                                                context.getSource(),
                                                "command.mod_de_teste.itemforbid.clear.empty",
                            ...
                            context.getSource().sendSuccess(
                                    () -> ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemforbid.clear.success",
                ...
                .then(Commands.argument("item", ItemArgument.item(buildContext))
                        .executes(context -> {
                            ...
                            context.getSource().sendSuccess(() ->
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemunforbid.success",
                                            "Item "
                                                    + item.getDescription().getString()
        ...
        dispatcher.register(Commands.literal("itemallow")
                ...
                .then(Commands.argument("player", EntityArgument.player())
                        .executes(context -> {
                            ...
                            if (!changed) {
                                context.getSource().sendFailure(
                                        ModMessages.get(context.getSource(),
                                                "command.mod_de_teste.itemallow.player.already",
                            ...
                            context.getSource().sendSuccess(
                                    () -> ModMessages.get(context.getSource(),
                                            "command.mod_de_teste.itemallow.player",
                                            player.getName().getString()
                        ...
                        .then(Commands.argument("item", ItemArgument.item(buildContext))
                                .executes(context -> {
                                    ...
                                    if (ForbiddenItemsManager.hasFullBypass(player.getUUID())) {
                                        context.getSource().sendFailure(
                                                ModMessages.get(context.getSource(),
                                                        "command.mod_de_teste.itemallow.item.full_bypass",
                                                        player.getName().getString()
                                                                + " already has full item bypass.",
                                                        player.getName()
                                                )
                                    ...
                                    if (!ForbiddenItemsManager.isGloballyForbidden(item)) {
                                        context.getSource().sendFailure(
                                                ModMessages.get(
                                                        context.getSource(),
                                                        "command.mod_de_teste.itemallow.not_forbidden",
                                                        "Item "
                                                                + item.getDescription().getString()
                                                                + " is not forbidden.",
                                                        item.getDescription()
                                    ...
                                    if (ForbiddenItemsManager.hasItemBypass(
                                        ...
                                        context.getSource().sendFailure(
                                                ModMessages.get(
                                                        context.getSource(),
                                                        "command.mod_de_teste.itemallow.item.already",
                                                        player.getName().getString()
                                    ...
                                    context.getSource().sendSuccess(() ->
                                            ModMessages.get(context.getSource(),
                                                    "command.mod_de_teste.itemallow.item",
                                                    player.getName().getString()
                                                            + " can now bypass "
                                                            + item.getDescription().getString()
                                                            + ".",
                ...
                .then(Commands.literal("list").then(Commands.argument("player", EntityArgument.player())
                        .executes(context -> {
                            ...
                            if (!fullBypass && items.isEmpty()) {
                                context.getSource().sendFailure(
                                        ModMessages.get(context.getSource(),
                                                "command.mod_de_teste.itemallow.list.none",
                                                player.getName().getString()
                            ...
                            context.getSource().sendSuccess(
                                    () -> ModMessages.get(context.getSource(),
                                            "command.mod_de_teste.itemallow.list",
                                            player.getName().getString()
                                                    + " - Full bypass: "
                                                    + fullBypassText
                                                    + " - Specific items: "
                ...
                .then(Commands.literal("check").then(Commands.argument("player", EntityArgument.player())
                        .executes(context -> {
                            ...
                            if (fullBypass) {
                                context.getSource().sendSuccess(
                                        () -> ModMessages.get(context.getSource(),
                                                "command.mod_de_teste.itemallow.check.full",
                                                player.getName().getString()
                            ...
                            context.getSource().sendFailure(
                                    ModMessages.get(context.getSource(),
                                            "command.mod_de_teste.itemallow.check.no_full",
                                            player.getName().getString()
                        ...
                        .then(Commands.argument("item", ItemArgument.item(buildContext))
                                .executes(context -> {
                                    ...
                                    if (!ForbiddenItemsManager.isGloballyForbidden(item)) {
                                        context.getSource().sendFailure(
                                                ModMessages.get(context.getSource(),
                                                        "command.mod_de_teste.itemallow.check.item.not_forbidden",
                                                        "Item "
                                                                + item.getDescription().getString()
                                                                + " is not forbidden.",
                                                        item.getDescription()
                                    ...
                                    if (canBypass) {
                                        context.getSource().sendSuccess(
                                                () -> ModMessages.get(context.getSource(),
                                                        "command.mod_de_teste.itemallow.check.item.allowed",
                                                        player.getName().getString()
                                    ...
                                    context.getSource().sendFailure(
                                            ModMessages.get(context.getSource(),
                                                    "command.mod_de_teste.itemallow.check.item.denied",
                                                    player.getName().getString()
                ...
                .then(Commands.argument("player", EntityArgument.player())
                        .executes(context -> {
                            ...
                            context.getSource().sendSuccess(() ->
                                    ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemdisallow.player",
                                            player.getName().getString()
                        ...
                        .then(Commands.argument("item", ItemArgument.item(buildContext))
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() ->
                                            ModMessages.get(
                                                    context.getSource(),
                                                    "command.mod_de_teste.itemdisallow.item",
                                                    player.getName().getString()
                        ...
                        .executes(context -> {
                            ...
                            if (!changed) {
                                context.getSource().sendFailure(
                                        ModMessages.get(
                                                context.getSource(),
                                                "command.mod_de_teste.itemdisallow.all.none",
                                                player.getName().getString()
                                                        + " has no item bypass permissions.",
                                                player.getName()
                                        )
                            ...
                            context.getSource().sendSuccess(
                                    () -> ModMessages.get(
                                            context.getSource(),
                                            "command.mod_de_teste.itemdisallow.all.success",
